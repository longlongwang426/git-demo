<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PaperOutboxRead.aspx.cs" Inherits="Student_PaperOutboxRead" %>
            ...
            <tr>
                <td>
                    <table id="Table1" class="GbText" style="BORDER-COLLAPSE:collapse" bordercolor="#93bee2"
					    ...
					    <tr>
						    <td align="right" width="20%" height="30">论文下载 :</td>
						    <td height="30">&nbsp;&nbsp;&nbsp;
						    <asp:LinkButton ID="lnkdownfile" runat="server" onclick="lnkdownfile_Click">下载</asp:LinkButton>
						    <asp:Label ID="IsAccessory" runat="server" Visible="false">无论文</asp:Label>
                            </td>
					    </tr>
