...
public partial class Student_TaskRead : System.Web.UI.Page
{
    private int MailID;
    int typeid = 1;
    ...
    //    if (flag > 0)
    //    {
    //        Response.Write("<script>alert('此信息已被删除！');window.location='TaskManage.aspx';</script>");
    //    }
    //    else 
    //    {
    //        Response.Write("<script>alert('信息未被删除！');window.location='TaskRead.aspx';</script>");
    //    }
    //}
