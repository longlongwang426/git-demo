<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportOutbox.aspx.cs" Inherits="Student_ReportOutbox" %>
...
<body>
    <form id="ReportOutbox" runat="server">
                ...
                <RowStyle Height="25px" />
                    <Columns>
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="MailNo" 
                            DataNavigateUrlFormatString="./ReportOutboxRead.aspx?id={0}" DataTextField="Theme" 
                            HeaderText="主题" NavigateUrl="./ReportOutboxRead.aspx" SortExpression="Theme">
                ...
                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                    <tr>
                        <td align="center" width="100%" height="24">
                            ...
                            <asp:Label ID="Label1" runat="server" Text="您未发送任何开题材料！"></asp:Label>
