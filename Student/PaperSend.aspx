<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PaperSend.aspx.cs" Inherits="Student_PaperSend" %>
            ...
            <tr>
                <td>
                    <table class="GbText" style="BORDER-COLLAPSE:collapse" bordercolor="#93bee2"
					    ...
					    <tr>
						    <td align="right" width="20%" height="30">论文上传 :&nbsp;</td>
						    <td height="30">&nbsp;&nbsp;&nbsp;<asp:FileUpload ID="FileUploadMain"  CssClass="redButtonCss" runat="server" Width="300px" />
		                    &nbsp;<span style="color:Red"><font face="宋体">【论文只能是.doc、.docx、.xls、.xlsx、.ppt、.pptx、.rar、zip类型且上传文件小于50MB】</font></span></td>
					    </tr>
