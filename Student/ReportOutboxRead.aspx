<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportOutboxRead.aspx.cs" Inherits="Student_ReportOutboxRead" %>
...
<body>
    <form id="ReportOutboxRead" runat="server">
            ...
            <tr>
                <td>
                    <table id="Table1" class="GbText" style="BORDER-COLLAPSE:collapse" bordercolor="#93bee2"
					    ...
					    <tr>
						    <td align="right" width="20%" height="30">开题材料下载 :</td>
						    <td height="30">&nbsp;&nbsp;&nbsp;
						    <asp:LinkButton ID="lnkdownfile" runat="server" onclick="lnkdownfile_Click">下载</asp:LinkButton>
						    <asp:Label ID="IsAccessory" runat="server" Visible="false">无开题材料</asp:Label>
                            </td>
					    </tr>
