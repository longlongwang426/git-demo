<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MailRead.aspx.cs" Inherits="Teacher_MailRead" %>
                    ...
                    <table id="Table1" class="GbText" style="BORDER-COLLAPSE:collapse" bordercolor="#93bee2"
					    ...
					    <tr bgcolor="#E8F4FF">
						    <td align="center"  height="35" colspan="2">	
                                <asp:Button ID="btnReply" runat="server" Text="回复" class="redButtonCss" 
                                    onclick="btnReply_Click"/> <input type="button" value="返回"                                         onclick="history.back()" class="redButtonCss" />                    
						    </td>
					    </tr>
                    </table>
                </td>
