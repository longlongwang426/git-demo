<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ManageSub.aspx.cs" Inherits="Teacher_ManageSub" %>
               ...
               onpageindexchanging="gvSub_PageIndexChanging" PageSize="20">
                ...
                <Columns>
                   ...
                   <asp:TemplateField HeaderText="课题名称">
                    <ItemTemplate>
                      <asp:HyperLink ID="HyperLink1" runat="server" Text='<%#Eval("SubjectName")%>' NavigateUrl='<%#string.Format("~/Teacher/StuList.aspx?id={0}",Eval("SubjectID"))%>' ></asp:HyperLink>
                    </ItemTemplate>
                       <ItemStyle Width="15%" />
                   </asp:TemplateField>
                   <asp:TemplateField HeaderText="主要内容">
                    <ItemTemplate>
                      <asp:HyperLink ID="HyperLink1" runat="server" Text='<%#Eval("Memo")%>' NavigateUrl='<%#string.Format("~/Teacher/StuList.aspx?id={0}",Eval("SubjectID"))%>' ></asp:HyperLink>
                    </ItemTemplate>
                       <ItemStyle Width="25%" />
                   </asp:TemplateField>
                   ...
                   <asp:TemplateField HeaderText="已选人数">
                    <ItemTemplate>
                      <asp:HyperLink ID="HyperLink2" runat="server" Text='<%#Eval("NowPeople")%>' NavigateUrl='<%#string.Format("~/Teacher/StuList.aspx?id={0}",Eval("SubjectID"))%>' ></asp:HyperLink>
                    </ItemTemplate>
                       <ItemStyle Width="8%" />
                   </asp:TemplateField>
                ...
                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                        <tr>
                            <td align="center" width="100%" height="24">
                                <asp:Label ID="Label1" runat="server" Text="您目前没有被选课题！"></asp:Label>
                            </td>
                        </tr>
                    </table>
            </td>            
