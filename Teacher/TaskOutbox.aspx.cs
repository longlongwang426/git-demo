...
public partial class Teacher_TaskOutbox : System.Web.UI.Page
{
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        if (count == flag)
        {
            Response.Write("<script>alert('请先选择需要删除的记录');window.location.href='TaskOutbox.aspx';</script>");
        }
        else
        {
            Response.Write("<script>alert('已经删除所选记录');window.location.href='TaskOutbox.aspx';</script>");
        }
    }
