<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FinalDataOutbox.aspx.cs" Inherits="Teacher_FinalDataOutbox" %>
...
<body>
    <form id="FinalDataOutbox" runat="server">
                    ...
                    <RowStyle Height="25px" />
                        <Columns>
                            ...
                            <asp:HyperLinkField DataNavigateUrlFields="MailNo" 
                                DataNavigateUrlFormatString="./FinalDataOutboxRead.aspx?id={0}" DataTextField="Theme" 
                                HeaderText="主题" NavigateUrl="./FinalDataOutboxRead.aspx" SortExpression="Theme">
                            <HeaderStyle Width="50%" />
                            </asp:HyperLinkField>
                            <asp:BoundField DataField="AdminName" HeaderText="接收人" 
                    ...
                    <table cellspacing="0" cellpadding="0" width="100%" border="0">
                        <tr>
                            <td align="center" width="100%" height="24">
                                <asp:Label ID="Label1" runat="server" Text="您没有上传归档材料！"></asp:Label>
                            </td>
                        </tr>
                    </table>
                </td>
