<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FinalDataOutboxRead.aspx.cs" Inherits="Teacher_FinalDataOutboxRead" %>
...
<body>
    <form id="FinalDataOutboxRead" runat="server">
            ...
            <tr>
                <td>
                    <table cellspacing="0" cellpadding="0" width="100%" border="0">
                        <tr>
                            <td class = "Labels">
                                <span class="Newbutton"><font>&nbsp;我的归档材料</font></span></td>
            ...
            <tr>
                <td>
                    <table id="Table1" class="GbText" style="BORDER-COLLAPSE:collapse" bordercolor="#93bee2"
					    ...
					    <tr>
						    <td align="right" width="20%" height="30">归档材料下载 :</td>
						    <td height="30">&nbsp;&nbsp;&nbsp;
						    <asp:LinkButton ID="lnkdownfile" runat="server" onclick="lnkdownfile_Click">下载</asp:LinkButton>
						    <asp:Label ID="IsAccessory" runat="server" Visible="false">无归档材料</asp:Label>
                            </td>
					    </tr>
