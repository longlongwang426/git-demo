    ...
    <table bordercolor="#111111" height="1" cellspacing="0" cellpadding="0" width="100%" border="0">
        ...
        <div>
            ...
            <asp:ListItem>专科</asp:ListItem>
                  ...
                  <asp:TemplateField HeaderText="毕业设计年份:"><ItemTemplate><input type="text" id="subYear" runat="server" value='<%#Eval("SubjectTime") %>'  readonly="readonly"  /></ItemTemplate></asp:TemplateField>
