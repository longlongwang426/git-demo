...
public partial class Teacher_FinalDataOutbox : System.Web.UI.Page
{
    ...
    private void GetMail()
    {
        ...
        DataSet ds = ml.GetMyMail(3, senderid, mailtype);
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        if (count == flag)
        {
            Response.Write("<script>alert('请先选择需要删除的记录');window.location.href='FinalDataOutbox.aspx';</script>");
        }
        else
        {
            Response.Write("<script>alert('已经删除所选记录');window.location.href='FinalDataOutbox.aspx';</script>");
        }
    }
