<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AllSubjects.aspx.cs" Inherits="Teacher_AllSubjects" %>
       ...
       <td vAlign="top" height="38">
           <table borderColor="#111111" height="1" cellSpacing="0" cellPadding="0" width="100%" border="0">
                <tr height="30">
                    ...
                    <font color="#003366" size="2">&nbsp;&nbsp;&nbsp;全体课题</font></td>
                </tr>
           </table>
       </td> 
    </tr>
            ...
            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                <tr>
                    <td align="center" width="90" background="../image/maillistbutton2.gif" height="24">
                        <a href="AllSubjects.aspx" class="Newbutton"><font>&nbsp;全体课题</font></a></td>
    ...
    <tr>
        <td>
          <asp:GridView ID="gvSub" runat="server" CellPadding="4" ForeColor="#E8F4FF" 
               ...
               AllowPaging="True" UseAccessibleHeader="False"  PageSize="20" 
                onpageindexchanging="gvSub_PageIndexChanging">
                ...
                <Columns>
                   ...
                   <asp:BoundField DataField="MaxPeople" HeaderText="最大选题人数" >
                       <ItemStyle Width="10%" />
                    </asp:BoundField>
