...
public partial class Teacher_ReportRead : System.Web.UI.Page
{
    private int MailID;
    int typeid = 2;
    ...
    //    if (flag > 0)
    //    {
    //        Response.Write("<script>alert('此信息已被删除！');window.location='ReportManage.aspx';</script>");
    //    }
    //    else 
    //    {
    //        Response.Write("<script>alert('信息未被删除！');window.location='ReportRead.aspx';</script>");
    //    }
    //}
