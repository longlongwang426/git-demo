<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ZoneUpload.aspx.cs" Inherits="Public_DownloadZone_Default" %>
            ...
            <td>
                <table class="GbText" style="BORDER-COLLAPSE:collapse" bordercolor="#93bee2"
					...
					<tr>
		                ...
		                &nbsp;<span style="color:Red"><font face="宋体">【上传的文件只能是.doc、.docx、.xls、.xlsx、.ppt、.pptx、.rar、zip类型且上传文件小于50MB】</font></span></td>
					</tr>
					...
					<tr bgcolor="#E8F4FF">
						<td align="center"  height="35" colspan="2">
							<asp:Button ID="btn_Commit"  Height="20px"  CssClass="redButtonCss" Width="60px" 
                                ...
                                ValidationGroup="FileTypeBox" onclick="btn_Commit_Click" OnClientClick="javascript:return confirm('确定要上传吗？')" />
                            &nbsp; &nbsp;			
