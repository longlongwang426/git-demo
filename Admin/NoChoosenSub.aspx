<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NoChoosenSub.aspx.cs" Inherits="Admin_NoChoosenSub" %>
...
<body>
    ...
    <div>
         <table bordercolor="#111111" height="1" cellspacing="0" cellpadding="0" width="100%" border="0">
                    <tr height="30">
                        <td class="Header">
                            <font color="#003366" size="2">&nbsp;&nbsp;&nbsp;未被选课题信息</font>
                        </td>
                    </tr>
                </table>
 <table><tr>
 ...
 <td class="Labels"><a href="NoChoosenSub.aspx" class="Newbutton">未被选题信息</a></td>
 <td class="Labelf"><a href="SubAndStu.aspx" class="Newbutton">所有课题信息</a></td>
 <td><asp:Button ID="btnDown" runat="server" Text="导出未被选课题信息" CssClass="redButtonCss" 
