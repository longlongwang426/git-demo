<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DetailSub.aspx.cs" Inherits="Admin_DetailSub" %>
       ...
       <td vAlign="top" height="38">
           <table borderColor="#111111" height="1" cellSpacing="0" cellPadding="0" width="100%" border="0">
                <tr height="30">
                    ...
                    <font color="#003366" size="2">&nbsp;&nbsp;&nbsp;课题信息</font></td>
                </tr>
           </table>
       </td> 
    </tr>
        ...
        <div>
           <asp:DetailsView id="dvSub" runat="server" cellpadding="3"                 bordercolor="#93BEE2" Width="100%"                 AutoGenerateRows="False">
                ...
                <FooterTemplate>
                 <input id="Button1" type="button" class="redButtonCss" value="返回" onclick="javascript:parent.frames['main'].location.href='ManageSub.aspx'"/>
                </FooterTemplate>
                <Fields>
                    ...
                    <asp:BoundField DataField="n2" HeaderText="指导老师2" 
                        ...
                        SortExpression="p2" />
                    <asp:BoundField DataField="Memo" HeaderText="简介" SortExpression="Memo" />                    <asp:BoundField DataField="SuitYear" HeaderText="课题年份" 
                    ...
                    <asp:TemplateField HeaderText="审核状态"><ItemTemplate><asp:CheckBox ID="cb" runat="server" AutoPostBack="true" Checked='<%#Eval("IsCheck") %>' OnCheckedChanged="ChangeChecked"/></ItemTemplate></asp:TemplateField>
                </Fields>
