<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HasChoosenSub.aspx.cs" Inherits="Admin_HasChoosenSub" %>
...
<body>
    ...
    <div>
             <table bordercolor="#111111" height="1" cellspacing="0" cellpadding="0" width="100%" border="0">
                    <tr height="30">
                        <td class="Header">
                            <font color="#003366" size="2">&nbsp;&nbsp;&nbsp;已被选题信息</font>
                        </td>
                    </tr>
                </table>
 <table><tr>
 ...
 <td class="Labels"><a href="HasChoosenSub.aspx" class="Newbutton">已被选题信息</a></td>
 ...
 <td class="Labelf"><a href="SubAndStu.aspx" class="Newbutton">所有课题信息</a></td>
  <td><asp:Button ID="btnDown" runat="server" Text="导出被选题信息" CssClass="redButtonCss" 
               ...
               <FooterStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
                ...
                <Columns>
                   <asp:BoundField DataField="PId"  HeaderText="序号"/>
                      <asp:HyperLinkField DataNavigateUrlFields="SubjectID" DataNavigateUrlFormatString="~/Admin/StuList.aspx?id={0}"
                        DataTextField="SubjectName" HeaderText="课题名称" DataTextFormatString="{0}" />
